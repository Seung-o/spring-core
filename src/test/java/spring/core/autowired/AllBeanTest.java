...
public class AllBeanTest {
    ...
    void findAllBean() {
        ...
        int discountPrice = discountService.getDiscount(member, 10000, "fixDiscountPolicy");
        Assertions.assertThat(discountService).isInstanceOf(DiscountService.class);
        Assertions.assertThat(discountPrice).isEqualTo(1000);
        int rateDiscountPrice = discountService.getDiscount(member, 10000, "rateDiscountPolicy");
    ...
    static class DiscountService {
        ...
        public int getDiscount(Member member, int price, String discountCode) {
